  ...
  return (
    <div className="right-container">
      <div className="card-right default">
        <h4>
          Did you know you can follow popular developer podcasts right here on
          DEV?
        </h4>
        <p>
          Visit <a href="#">dev.to/pod</a> to discover new audio!
        </p>
      </div>
      <div className="long-card default">
        ...
        <p>[MongoDB Submission Post Placeholder Title]</p>
        <p>
          E-commerce website with a powerful search engine equipped with
          autocomplete
        </p>
